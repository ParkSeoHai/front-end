  ...
  const fetchAllData = async () => {
    try {
      const [typesRes, pricesRes, stylesRes, suppliersRes,categoriesRes,sizesRes] = await Promise.all([
        axios.get('http://https://back-end-gray-pi.vercel.app:8080/api/product-types', getAuthHeader()),
        axios.get('http://https://back-end-gray-pi.vercel.app:8080/api/prices', getAuthHeader()),
        axios.get('http://https://back-end-gray-pi.vercel.app:8080/api/styles', getAuthHeader()),
        axios.get('http://https://back-end-gray-pi.vercel.app:8080/api/suppliers', getAuthHeader()),
        axios.get('http://https://back-end-gray-pi.vercel.app:8080/api/categories', getAuthHeader()),
        axios.get('http://https://back-end-gray-pi.vercel.app:8080/api/sizes', getAuthHeader())
      ]);
